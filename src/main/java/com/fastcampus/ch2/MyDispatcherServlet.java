...
// @WebServlet = 스프링의 @Controller + @RequestMapping 합친 것과 비슷
// 서블릿 : 클래스 단위로 맵핑 가능.. 따라서 클래스를 많이 만들어야 되는 단점 / HttpServlet 상속받아야함
// 			/ 메서드 이름은 service여야 함 / 매개변수 request, response
// 스프링 : 메서드 단위로 맵핑 가능 !
...
public class MyDispatcherServlet extends HttpServlet {
	...
	public void service(HttpServletRequest request, HttpServletResponse response) throws IOException {
		Map    map = request.getParameterMap(); // year, month, day 가 Key-Vlaue로 맵으로 가져와짐
		Model  model = null;
		String viewName = "";
